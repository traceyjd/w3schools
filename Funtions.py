...
my_function(fname = "Tobias", lname = "Jones")
...
# We use the k variable as the data, which decrements (-1) every time we recurse. The recursion ends when the
